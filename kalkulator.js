$(function () {
    ...
    $(".tombol-angka").click(function () {     
        let angka = $(this).text();
        // alert("Hallo JQuary! Kamu menekan angka " + angka);
    ...
    $(".tombol-operasi").click(function () {
        let operasiSebelumnya = $("#operasi1-selected").text();
        let newOperasi1 = $(this).text();
        if (operasiSelected == null) {
            // operasi baru
            $("#operasi-selected").text(newOperasi1);
            operasiSelected = newOperasi1;
        } else {
